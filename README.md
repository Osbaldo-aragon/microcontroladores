...
2. Abre el archivo fuente del proyecto que desees revisar.
3. Compílalo en **CCS C** si trabajas con PIC.
4. Si el proyecto incluye simulación, ábrelo en **Proteus 8.11**.
5. Para los ejemplos seriales, utiliza un **monitor serial a 9600 baudios**.
6. Adapta el código a tu hardware, frecuencia de reloj y conexiones.
